...
{
    public class HelmetSlotUI : MonoBehaviour, IPointerEnterHandler, IPointerClickHandler, ISelectHandler, ISubmitHandler
    {
        ...
        public void Initialize(HelmetEquipmentItemConfig config)
        {
            _config = config;
            if (_config != null)
            {
